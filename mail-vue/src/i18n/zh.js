const zh = {
    ...
    physicsDeleteConfirm: '确认彻底删除该邮件吗？删除后不可恢复',
    scheduleSend: '定时发送',
    scheduleTime: '选择发送时间',
    scheduleSuccessMsg: '已加入定时发送',
    emptyScheduleTimeMsg: '请选择定时发送时间',
    invalidScheduleTimeMsg: '定时发送时间至少需晚于当前1分钟',
    scheduleFailed: '发送失败',
    trashHint: '已删除邮件将保留30天',
    delSuccessMsg: '删除成功',
    ...
    verifyModuleFailed: '人机验证模块加载失败，请重试',
    retry: '重试',
    popUp: '弹出',
