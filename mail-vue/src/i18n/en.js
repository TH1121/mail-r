const en = {
    ...
    physicsDeleteConfirm: 'Permanently delete this email? This cannot be undone.',
    scheduleSend: 'Schedule',
    scheduleTime: 'Schedule time',
    scheduleSuccessMsg: 'Scheduled successfully',
    emptyScheduleTimeMsg: 'Please select a schedule time',
    invalidScheduleTimeMsg: 'Schedule time must be at least 1 minute later',
    scheduleFailed: 'Failed',
    trashHint: 'Deleted emails are kept for 30 days',
    ...
    verifyModuleFailed: 'Verification module failed to load. Please retry',
    retry: 'Retry',
    popUp: 'Pop Up',
